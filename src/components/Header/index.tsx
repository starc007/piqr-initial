    ...
    <div className="px-4 h-16 py-3 border sticky top-0 z-20 bg-white/60 backdrop-blur-xl">
      <div className="flex justify-between items-center container mx-auto">
        ...
        <div className="flex items-center space-x-2">
          {isLoggedIn ? <button onClick={logout}   className="flex justify-center items-center border border-primary px-4 h-10 text-sm font-semibold rounded-full transition duration-300" >Logout</button> : 
          <Link
          href="/login"
